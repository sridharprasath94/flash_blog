...
mixin _$BlogModel {
 ...
 String get id;@JsonKey(name: 'poster_id') String get posterId; String get title; String get content;@JsonKey(name: 'image_url') String get imageUrl; List<String> get topics;@JsonKey(name: 'updated_at') DateTime get updatedAt;@JsonKey(name: 'poster_name') String? get posterName;
...
@useResult
$Res call({
 String id,@JsonKey(name: 'poster_id') String posterId, String title, String content,@JsonKey(name: 'image_url') String imageUrl, List<String> topics,@JsonKey(name: 'updated_at') DateTime updatedAt,@JsonKey(name: 'poster_name') String? posterName
});
...
class _BlogModel implements BlogModel {
  const _BlogModel({required this.id, @JsonKey(name: 'poster_id') required this.posterId, required this.title, required this.content, @JsonKey(name: 'image_url') required this.imageUrl, required final  List<String> topics, @JsonKey(name: 'updated_at') required this.updatedAt, @JsonKey(name: 'poster_name') this.posterName}): _topics = topics;
...
@override@JsonKey(name: 'poster_name') final  String? posterName;
